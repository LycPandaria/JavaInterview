...
假设给定数组 arr = {1,5,6,7,9,2,4,8,10,13,14}, mid=5, arr[0~4] 和 arr[5~9] 都是有序的。
...
一般而言，对二叉树的操作通过递归方式比较容易实现。这题主要思想如下：首先，求左子树距根节点的最大距离，记为leftMaxDistance;
