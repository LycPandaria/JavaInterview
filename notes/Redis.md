...
<div align="center"> <img src="../pic/6019b2db-bc3e-4408-b6d8-96025f4481d6.png" width="400"/> </div><br>

| 命令 | 行为 |
| :--: | :--: |
| GET | 获取存储在给定键中的值 |
| SET | 设置存储在给定键中的值 |
| DEL |  删除存储在给定键中的值（ 适用于所有类型呢） |
...
<div align="center"> <img src="../pic/fb327611-7e2b-4f2f-9f5b-38592d408f07.png" width="400"/> </div><br>

| 命令 | 行为 |
| :--: | :--: |
| RPUSH | 将给定值推入列表右端 |
| LRANGE |  获取列表在给定范围上的值，参数是 2 个 index |
| LINDEX |  获取列表在给定位置上的单个元素，参数是 1 个index |
| LPOP | 从列表的左端弹出一个值，并返回被 弹出的值 |
...
<div align="center"> <img src="../pic/cd5fbcff-3f35-43a6-8ffa-082a93ce0f0e.png" width="400"/> </div><br>
...
<div align="center"> <img src="../pic/beba612e-dc5b-4fc2-869d-0b23408ac90a.png" width="600px"/> </div><br>

在查找时，从上层指针开始查找，找到对应的区间之后再到下一层去查找。下图演示了查找 22 的过程。

<div align="center"> <img src="../pic/0ea37ee2-c224-4c79-b895-e131c6805c40.png" width="600px"/> </div><br>
...
<div align="center"> <img src="../pic/9ea86eb5-000a-4281-b948-7b567bd6f1d8.png" width=""/> </div><br>
...
<div align="center"> <img src="../pic/c0a9fa91-da2e-4892-8c9f-80206a6f7047.png" width="350"/> </div><br>
...
<div align="center"> <img src="../pic/395a9e83-b1a1-4a1d-b170-d081e7bb5bab.png" width="600"/> </div><br>
