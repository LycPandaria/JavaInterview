...
**转载自[CyC2018](https://github.com/CyC2018/CS-Notes/blob/master/notes/%E7%BC%93%E5%AD%98.md)的学习笔记**
...
<div align="center"> <img src="../pic/hc1.jpg"/> </div><br>
...
<div align="center"> <img src="../pic/hc2.jpg"/> </div><br>

一致性哈希在增加或者删除节点时只会影响到哈希环中相邻的节点，例如下图中新增节点 X，只需要将它后一个节点 C 上的数据重新进行分布即可，对于节点 A、B、D 都没有影响。

<div align="center"> <img src="../pic/hc3.jpg"/> </div><br>
